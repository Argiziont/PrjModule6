...
{
    [Serializable]
    public sealed class Rectangle : Quadrangle, IComparer
    {
        ...
        public Rectangle(double[] aCords, double[] bCords, double[] cCords, double[] dCords)
        {
        ...
        {
            throw new FigureMathException("Couldn't inscribe circle");
        }
