...
{
    [Serializable]
    public sealed class Parallelogram : Quadrangle, IComparer
    {
        ...
        /// <summary>
        /// Creates instance of parallelogram
        /// </summary>
        ...
        public Parallelogram(double[] aCords, double[] bCords, double[] cCords, double[] dCords)
        {
            ...
            if (!(FigureMathHelper.GetParallelism(AVertex, BVertex, CVertex, DVertex)&& 
                  FigureMathHelper.GetParallelism(AVertex, DVertex, BVertex, CVertex)))
