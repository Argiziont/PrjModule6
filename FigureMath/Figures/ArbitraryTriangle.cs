...
{
    [Serializable]
    public sealed class ArbitraryTriangle : Triangle, IComparer
    {
        ...
        /// <summary>
        /// Creates instance of arbitrary triangle
        /// </summary>
        ...
        public ArbitraryTriangle(double[] aCords, double[] bCords, double[] cCords)
        {
