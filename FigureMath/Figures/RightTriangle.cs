...
{
    [Serializable]
    public sealed class RightTriangle : Triangle, IComparer
    {
        ...
        /// <summary>
        /// Creates instance of right triangle
        /// </summary>
        ...
        public RightTriangle(double[] aCords, double[] bCords, double[] cCords)
        {
            ...
            if (!(Math.Abs(GetAngles()[0] - 90) < Tolerance || Math.Abs(GetAngles()[1] - 90) < Tolerance || Math.Abs(GetAngles()[2] - 90) < Tolerance))
