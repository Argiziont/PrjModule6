...
{
    [Serializable]
    public sealed class Square : Quadrangle, IComparer
    {
        ...
        public Square(double[] aCords, double[] bCords, double[] cCords, double[] dCords)
        {
            ...
            if (!(Math.Abs(AbDirect - BcDirect) < Tolerance &&
                  Math.Abs(AbDirect - CdDirect) < Tolerance &&
                  Math.Abs(AbDirect - DaDirect) < Tolerance &&
                  Math.Abs(GetAngles()[0] - 90) < Tolerance &&
                  Math.Abs(GetAngles()[1] - 90) < Tolerance &&
                  Math.Abs(GetAngles()[2] - 90) < Tolerance &&
                  Math.Abs(GetAngles()[3] - 90) < Tolerance))
                throw new FigureMathException("This is not square");
        }
