...
namespace FigureMath.Tests
{
    public class EquilateralTriangleTests
    {
        ...
        public void Constructor_Passes_InputIsCorrect()
        {
            ...
            var bVertex = new[] {1f / 2f, Math.Sqrt(3) / 2f};
            var cVertex = new double[] {1, 0};

            // Act
            var result = Record.Exception(() => new EquilateralTriangle(aVertex, bVertex, cVertex));
        ...
        public void Constructor_ThrowsFigureMathException_InputIsInCorrect()
        {
            ...
            void result()
            {
                new EquilateralTriangle(aVertex, bVertex, cVertex);
            }
        ...
        public void GetArea_ReturnsDouble_InputIsCorrect()
        {
            ...
            var bVertex = new[] {1f / 2f, Math.Sqrt(3) / 2f};
            var cVertex = new double[] {1, 0};
            var triangle = new EquilateralTriangle(aVertex, bVertex, cVertex);
