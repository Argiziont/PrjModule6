...
namespace FigureMath.Tests
{
    public class RightTriangleTests
    {
        ...
        public void Constructor_Passes_InputIsCorrect()
        {
            ...
            var bVertex = new double[] {0, 1};
            var cVertex = new double[] {1, 0};

            // Act
            var result = Record.Exception(() => new RightTriangle(aVertex, bVertex, cVertex));
        ...
        public void Constructor_ThrowsFigureMathException_InputIsInCorrect()
        {
            ...
            void result()
            {
                new RightTriangle(aVertex, bVertex, cVertex);
            }
        ...
        public void GetArea_ReturnsDouble_InputIsCorrect()
        {
            ...
            var bVertex = new double[] {0, 1};
            var cVertex = new double[] {1, 0};
            var triangle = new RightTriangle(aVertex, bVertex, cVertex);
